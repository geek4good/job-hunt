// src/scrapers/remote100k.ts — Remote100K scraper ($100K+ remote jobs)
//
// Framer static site — requires Lightpanda for dynamic job loading.
...
const URL = "https://remote100k.com/jobs";
...
export const remote100k: Scraper = {
  name: "Remote100K",
  ...
  async scrape(): Promise<Job[]> {
    ...
    if (!looksLikeJobListings(html) && hasBrowser) {
      console.log(`   [${this.name}] Dynamic site detected, retrying with Lightpanda...`);
