// src/scrapers/remotesource.ts — Remote Source scraper
//
// React SSR streaming — requires Lightpanda (set LPD_TOKEN or LPD_CDP_URL).
...
const URL = "https://www.remotesource.com/jobs";
...
export const remotesource: Scraper = {
  name: "Remote Source",
